...
- An accesstoken is valid for 1 hour so _do_ cache it
...
`curl -X PUT -H "Content-Type: application/json" -d 'locationDescriptor'='Malmoe' -d 'specialOpenHours'='[{"start": "2018-12-31","end":"2018-12-31","openTime":"1100", "closeTime": "1500", "isClosed": false, "label":"New Years Eve"}]' https://api.pinmeto.com/v2/<<account_id>>/locations/YOUR_STORE_ID/?access_token=YOUR_ACCESS_TOKEN`
